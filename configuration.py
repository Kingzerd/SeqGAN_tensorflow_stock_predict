class generator_config(object):
    ...
    def __init__(self):
        ...
        self.num_emb = 5000  # dimension of output unit 5000
...
class discriminator_config(object):
    ...
    def __init__(self):
        ...
        self.vocab_size = 5000  # vocabulary size, shoud be same as num_emb 5000
...
class training_config(object):
    ...
    def __init__(self):
        ...
        self.pretrained_epoch_num = 40  # Number of pretraining epoch 120
        ...
        self.save_pretrained = 40  # Whether to save model in certain epoch (optional) 40
        ...
        self.total_batch = 200  # total batch used for adversarial training 200
        ...
        self.generated_num = 10000  # Number of samples from generator used for evaluation 10000
